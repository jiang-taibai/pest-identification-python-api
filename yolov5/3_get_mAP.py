...
GT_PATH = os.path.join(os.getcwd(), 'mAP', 'input', 'ground-truth')
DR_PATH = os.path.join(os.getcwd(), 'mAP', 'input', 'detection-results')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'mAP', 'input', 'images-optional')
